...
### 5. 目前上传PyUSB还是早期版本
    __pyusb_fx2_samples.py__ is a sample script which saving as txt format and using in raspberry pi.
    __pyusb_sample_fx2_vcd.py__ is a txt format to vcd for sigrok script which using in PC.
    __script.py__ is a automatic script for USB sample Tracing data and GPIO captured.
