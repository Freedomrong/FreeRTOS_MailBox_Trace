...
# response = subprocess.Popen('./GPIO_Interrupt mailbox_timestamp.txt ',shell=True)
...
subprocess.Popen('./GPIO_Interrupt mailbox_timestamp.txt ',shell=True)
print('开始USB采集过程')
# find our device
